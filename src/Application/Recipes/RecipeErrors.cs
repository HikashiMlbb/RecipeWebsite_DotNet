...
public static class RecipeErrors
{
    ...
    public static readonly Error CookingTimeIsTooSmall = new("Recipe.CookingTime", "Given recipe cooking time is too small.");
    ...
    public static readonly Error UserIsNotAuthor = new("Recipe.Author", "The User is not Author of the Recipe to be able to change it.");
}