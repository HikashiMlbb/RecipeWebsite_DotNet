...
public class RecipeRateUseCase
{
    private readonly IRecipeRepository _recipeRepo;

    public RecipeRateUseCase(IRecipeRepository recipeRepo)
    {
    ...
    public async Task<Result> Rate(RecipeRateDto dto)
    {
        ...
        if (!areStarsDefined || dto.Stars == 0)
        {
            return RecipeErrors.StarsAreNotDefined;
        }
