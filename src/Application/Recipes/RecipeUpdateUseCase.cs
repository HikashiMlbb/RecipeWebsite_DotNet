...
public class RecipeUpdateUseCase
{
    ...
    public RecipeUpdateUseCase(IRecipeRepository recipeRepo)
    {
    ...
    public async Task<Result> UpdateAsync(RecipeUpdateDto dto)
    {
        ...
        if (userId != foundRecipe.AuthorId)
        {
        ...
        {
            if (!Enum.IsDefined((RecipeDifficulty)rawDifficulty))
            {
        ...
        if (dto.CookingTime is { } rawCookingTime)
        {
            ...
            {
                return RecipeErrors.CookingTimeIsTooSmall;
            }
